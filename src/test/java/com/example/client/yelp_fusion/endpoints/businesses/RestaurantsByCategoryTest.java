    ...
    void createDocumentsByCategoryAndLocationTest() throws IOException {
        ...
        for(Category category : subCategoriesOfRestaurant) {
            ...
            do {
                ...
                TestBusinessSearchRequest businessSearchRequest = new TestBusinessSearchRequest.Builder()
                        .limit(limit)
                ...
                BusinessEndpointResponse businessSearchResponse =
                        yelpClient.businessSearch(businessSearchRequest); //submit the request to yelp

                totalHits = PrintUtils.println(businessSearchResponse.getTotal());
                ...
                if (totalHits > 0) {
                    ...
                    List<Business> businesses = businessSearchResponse.getBusinesses();
