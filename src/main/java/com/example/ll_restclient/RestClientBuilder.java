...
public final class RestClientBuilder {
    ...
    private final List<com.example.ll_restclient.Node> nodes;
     ...
     */
    RestClientBuilder(List<com.example.ll_restclient.Node> nodes) {
        if (nodes == null || nodes.isEmpty()) {
            throw new IllegalArgumentException("nodes must not be null or empty");
        }
        for (com.example.ll_restclient.Node node : nodes) {
            if (node == null) {
