...
public class Time implements TaggedUnion<Time.Kind, Object>, JsonpSerializable {
    ...
    private Time(Time.Kind kind, Object value) {
        this._kind = kind;
        this._value = value;
    }
    ...
    private Time(Time.Builder builder) {
    ...
    public static Time of(Function<Builder, ObjectBuilder<Time>> fn) {
        return fn.apply(new Time.Builder()).build();
    }

    public boolean isOffset() {
        return _kind == Time.Kind.Offset;
    }

    public Integer offset() {
        return TaggedUnionUtils.get(this, Time.Kind.Offset);
    }

    public boolean isTime() {
        return _kind == Time.Kind.Time;
    }
    public String time() {
        return TaggedUnionUtils.get(this, Time.Kind.Time);
    }
    ...
    private static JsonpDeserializer<Time> buildTimeDeserializer() {
        return new UnionDeserializer.Builder<Time, Time.Kind, Object>(Time::new, false)
                .addMember(Time.Kind.Offset, JsonpDeserializer.integerDeserializer())
                .addMember(Time.Kind.Time, JsonpDeserializer.stringDeserializer()).build();
    }
